  ...
  <div class="add">
    <el-tabs v-model="activeName">
      <el-tab-pane name="first">
        <template #label><i class="el-icon-circle-plus"><el-icon><CirclePlusFilled /></el-icon></i>添加试题</template>
      ...
      <el-tab-pane name="second">
        <template #label><i class="iconfont icon-daoru-tianchong"></i>在线组卷</template>
        <div class="box">
          <ul>
            <li>
              <span>试题难度:</span>
...
export default {
  ...
  methods: {
    ...
    getParams() {
      let subject = router.currentRoute.value.query.subject //获取试卷名称
      let paperId = router.currentRoute.value.query.paperId //获取paperId
